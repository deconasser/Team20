...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/data/Aicity2025/train.json',
        img_prefix='/data/Aicity2025/train_img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/data/Aicity2025/test.json',
        img_prefix='/data/Aicity2025/test_img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
